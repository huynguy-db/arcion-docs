...
You can enable delta-snapshot replication by running Replicant with the `delta-snapshot` argument. For more information, see [Replicant delta-snapshot mode]({{< ref "docs/running-replicant#replicant-delta-snapshot-mode" >}}).
